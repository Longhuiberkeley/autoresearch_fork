# Probe Workflow — /autoresearch_probe
...
Single batched `question` with ≤5 synthesized questions. Interactive mode (default) or autonomous mode (`--mode autonomous` — self-answers with confidence levels: high/med/low).

...
If `Context-Mode: fresh` is set, read `.claude/skills/autoresearch/references/context-rotation-protocol.md` and use worker subagent dispatch in Phase 3 instead of inline modification.
